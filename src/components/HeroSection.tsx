        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
          ...
          <div className="sm:text-center lg:text-left lg:mr-8">
            <h1 className="text-4xl tracking-tight font-bold text-gray-900 sm:text-5xl md:text-6xl">
              ...
              <span className="block text-kisan-green-dark">
                With Fertilizers
              </span>
            </h1>
            <p className="mt-3 text-base text-gray-700 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto lg:mx-0 md:mt-5 md:text-xl">
              KisanSarthi helps farmers optimize their fertilizer usage, improve
              crop yields, and cultivate sustainable farming practices through
          ...
          <div className="mt-12 relative lg:mt-0 flex justify-center animate-float">
            <div className="relative mx-auto w-full max-w-md">
              ...
              <div
                className="absolute -top-4 -right-4 w-16 h-16 bg-kisan-yellow rounded-full opacity-70 animate-float"
                style={{ animationDelay: "1s" }}
              ></div>
              <div
                className="absolute -bottom-6 -left-6 w-20 h-20 bg-kisan-blue rounded-full opacity-60 animate-float"
